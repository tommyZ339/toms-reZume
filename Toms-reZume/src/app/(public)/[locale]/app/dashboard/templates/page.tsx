...
function TemplatesPageContent() {
  ...
  const handleCreateResume = (templateId: string) => {
    ...
    router.push(`/${locale}/app/workbench/${resumeId}`);
  };
  ...
  return (
    <div className="container mx-auto lg:ml-2 py-6 px-4">
      <div className="flex flex-col space-y-8">
        ...
        >
          {previewTemplate && (
            <DialogContent className="max-y-[80vh] overflow-y-auto p-0 border-0 shadow-lg rounded-xl bg-white dark:bg-gray-900">
              <div className="flex flex-col">
                ...
                <div className="overflow-y-auto flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
